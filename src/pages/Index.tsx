        ...
        <section className="bg-gradient-to-br from-primary-800 via-primary-700 to-primary-900 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/pdvlegal"
                className="bg-secondary hover:bg-secondary-600 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 hover:shadow-lg animate-scale-in"
              >
        ...
        <section className="py-16 bg-neutral-100">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* PDVLegal Card */}
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-neutral-200 animate-fade-in">
                <img
                ...
                />
                <div className="p-6">
                  <h3 className="text-2xl font-bold mb-4 text-primary-800">PDVLegal</h3>
                  ...
                  <Link
                    to="/pdvlegal"
                    className="inline-block bg-primary-800 hover:bg-primary-900 text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                  >
                    Acessar Tutoriais
                  </Link>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-neutral-200 animate-fade-in">
                ...
                />
                <div className="p-6">
                  <h3 className="text-2xl font-bold mb-4 text-primary-800">Hiper</h3>
                  <p className="text-neutral-600 mb-6">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center animate-fade-in">
                ...
                <h3 className="text-xl font-bold mb-2 text-primary-800">Passo a Passo</h3>
              ...
              <div className="text-center animate-fade-in">
                <div className="w-16 h-16 bg-accent-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <svg className="w-8 h-8 text-primary-800" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M8 5v14l11-7z"/>
                  </svg>
                </div>
                <h3 className="text-xl font-bold mb-2 text-primary-800">Vídeos HD</h3>
                <p className="text-neutral-600">
              ...
              <div className="text-center animate-fade-in">
                ...
                <h3 className="text-xl font-bold mb-2 text-primary-800">Atualizado</h3>
                <p className="text-neutral-600">
