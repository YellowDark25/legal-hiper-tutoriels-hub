...
import videosData from '@/data/videos-hiper.json';
    ...
    const fetchData = async () => {
      try {
        ...
        const [videosFromDB, tagsData, categoriesData] = await Promise.all([
          videoService.getVideosBySystem('hiper'),
      ...
      <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
        ...
        <main className="flex-1 pt-16 flex items-center justify-center">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 mx-auto mb-4" style={{ borderBottomColor: '#7C3AED' }}></div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center mb-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border border-white/20 mb-4 md:mb-0 md:mr-6 flex items-center justify-center min-w-[80px] min-h-[80px]">
                  <img 
                    ...
                    onLoad={() => console.log('Logo Hiper carregada com sucesso')}
                  />
                  {/* Fallback icon */}
                  <svg 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  ...
                  <div className="text-purple-100 text-sm">Tutoriais</div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  ...
                  <div className="text-purple-100 text-sm">Prático</div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  ...
                  <div className="text-purple-100 text-sm">Atualizado</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 transition-colors duration-200">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center">
                  ...
                  <div className="relative flex-1">
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-4 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent shadow-sm bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200"
                    />
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 px-8 py-4 rounded-xl bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                  >
                ...
                {(selectedCategory !== 'Todas' || selectedTags.length > 0 || searchTerm) && (
                  <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-600">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {searchTerm && (
                        <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200">
                          Busca: "{searchTerm}"
                          <button
                      ...
                      {selectedTags.map(tagId => {
                        ...
                        return tag ? (
                          <span key={tagId} className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200">
                            {tag.nome}
                            <button
          ...
          <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
            ...
            <DialogContent className="fixed left-1/2 top-1/2 z-50 max-w-2xl w-full -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="mb-8">
                <label className="block text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200 flex items-center">
                  <svg className="w-5 h-5 mr-2 text-indigo-600 dark:text-indigo-400" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-sm font-semibold transition-all duration-200 border-2 ${
                        selectedTags.includes(tag.id)
                          ? 'bg-gradient-to-r from-indigo-600 to-indigo-700 text-white border-indigo-600 shadow-lg scale-105'
                          : 'bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 border-gray-200 dark:border-gray-600 hover:border-indigo-300 dark:hover:border-indigo-500'
                      }`}
                    >
                      {tag.nome}
                    </button>
              ...
              <div className="flex justify-end gap-4 mt-8 pt-6 border-t border-gray-200 dark:border-gray-600">
                ...
                <button
                  ...
                  className="px-8 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                >
                  Aplicar Filtros
                </button>
              </div>
            ...
            {filteredVideos.length === 0 ? (
              <div className="text-center py-20">
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-gray-700 p-12 max-w-md mx-auto">
                  ...
                  <button
                    onClick={clearFilters}
                    className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                  >
                    Limpar Filtros
                  </button>
                </div>
              ...
              <>
                ...
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="text-right">
                    <div className="bg-purple-100 dark:bg-purple-900 rounded-full px-4 py-2 inline-block mb-2">
                              ...
                              <PaginationItem key={page}>
                                <PaginationLink
                                  ...
                                  className={currentPage === page 
                                    ...
                                    : 'text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-300 border-gray-300 dark:border-gray-600'
                                  }
                                >
                                  {page}
                                </PaginationLink>
